<template>
  <div class="p-6 mt-20">
   ...
   <div v-if="show === true" class="flex flex-col mt-10 w-full">
      ...
      <form @submit.prevent="onSubmit(formData.id)" class="w-1/2 mx-auto p-8 bg-white shadow-md rounded-lg">
        <div class="mb-6">
        ...
        <!-- <div class="mb-6">
          <label class="block text-gray-600 text-sm font-medium mb-2">Upload Images</label>
          <input
            type="file"
            multiple
            @change="onFileChange"
...
import {Update_Event_ById} from "../../components/graphql/queries"
import {DELETE_EVENT_BY_ID} from "../../components/graphql/queries"
